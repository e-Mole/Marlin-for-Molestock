...
#define MSG_BED_LEVEL                       "G29 Bed Leveling" // TFs mod
#define MSG_G29_RUN			    "Bed leveling..." // TFs mod
#define MSG_G29_END			    "Bed leveling done" // TFs mod
#define MSG_PRINTING            "Printing..." // TFs mod  
 	//TFs mod: EASY_LOAD
  ...
  #define MSG_E_BOWDEN_TEST "Extr. test " STRINGIFY(LCD_BOWDEN_LENGTH_TEST) "mm"
 	#define MSG_R_BOWDEN_TEST "Retr. test " STRINGIFY(LCD_BOWDEN_LENGTH_TEST) "mm"
  //EASY_LOAD
