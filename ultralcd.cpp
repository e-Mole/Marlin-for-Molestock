...
static void lcd_purge_test()
{
	lcd_extrude(LCD_BOWDEN_LENGTH_TEST, LCD_BOWDEN_LENGTH_TEST_FEEDRATE/60);
}

static void lcd_retract_test()
{
	lcd_extrude(-LCD_BOWDEN_LENGTH_TEST, LCD_BOWDEN_LENGTH_TEST_FEEDRATE/60);
}
...
static void lcd_prepare_menu()
{
    ...
    MENU_ITEM(gcode, MSG_BED_LEVEL, PSTR("G29 n5"));
...
// TFs mod: EASY_LOAD
    ...
    MENU_ITEM(function, MSG_R_BOWDEN_LENGTH, lcd_easy_unload);
	  ...
	  MENU_ITEM(function, MSG_E_BOWDEN_TEST, lcd_purge_test);
	  MENU_ITEM(function, MSG_R_BOWDEN_TEST, lcd_retract_test);    
#endif
// EASY_LOAD 
#if PS_ON_PIN > -1
    if (powersupply)
